...
public class Pedido
{
    ...
    public double getImporteAntesIva() {
        double prod = linea1.getProducto().getPrecio() * linea1.getCantidad() +
    ...
    public double getImporteTotal() {
       double importe = (linea1.getProducto().getPrecio() * linea1.getCantidad() +
        linea2.getProducto().getPrecio() * linea2.getCantidad()) + getIva();
       return importe;  
    }
    ...
    public String toString() {
        ...
        "\n" + linea2.toString() +
        "\n **** A pagar **** ";
        str += String.format("%20s%8.2f" , "IMPORTE SIN IVA: ", getImporteAntesIva());
        str += String.format("%20s%8.2f" , "IVA: ", getIva());
        str += String.format("%20s%8.2f" , "IMPORTE TOTAL: ", getImporteTotal());
        return str;
    }
